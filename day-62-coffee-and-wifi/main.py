...
def add_cafe():
    ...
    if form.validate_on_submit():
        ...
        with open('cafe-data.csv', 'a', newline='') as csv_file:
            csv_file.write(
                f"\n{form.cafe.data},{form.location.data},{form.opening_time.data},{form.closing_time.data},{form.coffee_rating.data},{form.wifi_rating.data},{form.power_socket_availability.data}")
    # Exercise:
